...
newoption {
    trigger = "truth-integration",
    description = "Enables integration with the truth library for on-demand ECL compiling. Does not work in Emscripten!"
}
...
project "th06"
  ...
  if _OPTIONS["use-c23-embed"] ~= nil then
    ...
    filter "toolset:gcc"   buildoptions { "-Wnoc++26-extensions" }
    filter "toolset:clang" buildoptions { "-Wno-gnu-anonymous-struct", "-Wnoc++26-extensions" }
    filter {}
  else
  ...
  if _OPTIONS["truth-integration"] ~= nil then
    defines { "TRUTH_FFI_INTEGRATION" }
    -- TODO: I need to add windows builds for truth-ffi, and *maybe* even wasm builds?
  ...
  filter "system:emscripten"
    ...
    buildoptions { "-Wall", "-Wextra", "-Wpedantic", "-Wno-gnu-anonymous-struct", "-Wno-unused-parameter", "-Wno-unused-but-set-variable", "-Wno-unused-variable", "-Wno-nontrivial-memcall", "-Wno-c99-extensions", "-Wno-switch", "-Wno-c++11-narrowing", "-Wno-dollar-in-identifier-extension", "-Wno-logical-not-parentheses" }
