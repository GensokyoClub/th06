...
project "th06"
  ...
  if _OPTIONS["use-c23-embed"] ~= nil then
    ...
    filter "toolset:gcc"   buildoptions { "-Wall", "-Wextra", "-Wpedantic", "-Wno-c++26-extensions" }
    filter "toolset:clang" buildoptions { "-Wall", "-Wextra", "-Wpedantic", "-Wno-gnu-anonymous-struct", "-W-noc++26-extensions" }
    filter {}
  else
