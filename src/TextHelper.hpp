...
struct TextHelper {
    ...
    static void RenderTextToTexture(i32 xPos, i32 yPos, i32 spriteWidth, i32 spriteHeight, i32 fontHeight, i32 fontWidth,
    ...
    //    format); FormatInfo *GetFormatInfo(D3DFORMAT format); bool
    //    ReleaseBuffer() const;
