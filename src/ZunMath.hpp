...
inline u16 RotateLeft16(u16 n, u8 s) { return std::rotl(n, s); }
#else
...
inline u16 RotateLeft16(u16 n, u8 s) { return __builtin_rotateleft16(n, s); }
#else
inline u16 RotateLeft16(u16 n, u8 s) { return (u32)n >> 16 - s | n << s; }
#endif
