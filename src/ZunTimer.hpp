...
struct ZunTimer {
    ...
    bool operator==(i32 time) const { return this->current == time; }
    ...
    f32 AsFramesFloat() const { return this->current + this->subFrame; }

    i32 AsFrames() const { return this->current; }

    bool HasTicked() const { return this->current != this->previous; }
};
