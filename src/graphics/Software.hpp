...
// It is extremely recommended that you compile as Release if you want to use
// the software rasterizer because it runs extremely slow on Debug
...
struct Software : GfxInterface {
    ...
    virtual bool HasError() override { return false; };
