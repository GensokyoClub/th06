...
bool WebGL::Init() {
    ...
    // Using a hashset for this is definitely super overkill, but it still feels
    // more right
...
void WebGL::SetDepthMask(bool enable) { g_glFuncTable.glDepthMask(enable); }
...
void WebGL::SwapBuffers() { SDL_GL_SwapWindow(window); }
