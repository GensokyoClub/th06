...
bool MidiDevice::OpenDevice(u32 uDeviceId) {
    ...
    // Failing to open a connection here isn't necessarily a failure, but may
    // cause issues
...
bool MidiDevice::GetDestPort() {
    ...
    // Grab the first client / port combination that's either in hardware or a
    // software synthesizer
    //   This is really not the best way to do things, but anything better would
